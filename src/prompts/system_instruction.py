creator_profile = {
    ...
    "certifications": [
        ...
        "Active participation in Cacied 4 - Andean Congress - Computing, information and education",
        "Algebra Course",
        "Angular & Spring Boot",
        "Aws Security",
        ...
        "DEVELOPMENT OF THE IMPORT AND EXPORT OPERATION ACCORDING TO CUSTOMS REGULATIONS",
        ...
        "First Cybersecurity Congress - Pasto",
        ...
        "Marco web Django",
        "MARKET MANAGEMENT, MARKETING AND SALES - BASED ON THE CANVAS MODEL",
        "Mathematics Fundamentals Course",
        "NestJs: Desarrollo backend escalable con Node",
        "Object Oriented Java SE Course",
        "Programming Laboratory Participation",
        ...
        "Serverless Framework Course on AWS",
        "Speaker at the Fifth Andean Congress on Computing, Information Technology and Education - CACIED 2021",
        "Tools for Data Science",
        "Tools for Data Science V2",
        "TypeScript: Your Complete Guide and Handy Manual",
        "Understanding and Visualizing Data with Python",
        "Vue js 3 [Updated] From scratch + Vite + Firebase 9 + MEVN",
        "What is Data Science?",
        "14th CCC - Colombian Computer Congress Pasto 2019",
    ]
}
